...
namespace IrigasiManganti.Controllers
{
    ...
    public async Task<IActionResult> GetMasterDataSmopi(string date)
        {
            ...
            try
            {
                ...
                var (rekomendasi, recordsTotal) = await _unitOfWorkRepository.MasterDataRepositories.GetDataSmopi(ModelRequest, date);
